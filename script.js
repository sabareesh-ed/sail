...
function updateButtonInnerText(itemId) {
  ...
  if (buttonTextElement) {
    let htmlContent = isItemInCart 
        ...
        : '<span class="text-size-small" style="gap: 4px ; display: inline-flex; justify-content = center; align-items : center;"><span class="text-size-medium">+ </span>Add to quote</span>';
