...
function updateButtonInnerText(itemId) {
  ...
  if (buttonTextElement) {
    let htmlContent = isItemInCart 
        ...
        : '<span class="text-size-small" style="gap: 6px ; display: inline-flex; justify-content : center; align-items : center;"><span class="text-size-medium" style="margin-right: 4px;">+</span>Add to quote</span>';
